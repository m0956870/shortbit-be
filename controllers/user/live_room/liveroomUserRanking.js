...
const liveroomUserRanking = async (req, res, next) => {
    // console.log("liveroomUserRanking -------------------------->")
    try {
        ...
        const pipeline = [];
        let matchObj = { transaction_for: 'liveroom', transaction_by: 'user', $or: [{ item_type: 'gift' }, { item_type: 'coin' }], createdAt: { $gte: new Date(startDate) } }
...
module.exports = liveroomUserRanking;