...
const allUsersRanking = async (req, res, next) => {
    ...
    try {
        ...
        const pipeline = [];
        let matchObj = { transaction_by: 'user', $or: [{ item_type: 'gift' }, { item_type: 'coin' }], createdAt: { $gte: new Date(startDate) } }
...
module.exports = allUsersRanking;